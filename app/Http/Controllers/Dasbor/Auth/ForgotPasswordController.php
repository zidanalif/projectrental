...
/**
 * @author     localhost.test
 * @copyright  2020-2120
 * @link       https://localhost.test
 * @Help       We are always looking to improve our code. If you know better and more creative way don't hesitate to contact us. Thank you.
 */
namespace App\Http\Controllers\Dasbor\Auth;
...
class ForgotPasswordController extends Controller
{
    ...
    {
        return view('dasbor.auth.passwords.email');
    }
    ...
    public function sendResetLink(Request $request, Admins $Admins)
    {
        ...
        if ($email) {
            ...
            \Mail::to($email->email)->send(new \App\Http\Controllers\Dasbor\Auth\EmailResetLink($data));
    ...
    public function showResetForm(Request $request, Admins $Admins)
    {
        ...
        if ($token) {
            ...
            return view('dasbor.auth.passwords.reset')->with(compact('reset_token'));
        }
        return redirect(route('dasbor.login'));
    }
